  ...
  return (
    <AppBackground>
      <div className="relative z-10 mx-auto max-w-2xl px-4 py-16">
        ...
        <h1 className="mt-8 text-3xl font-bold text-app-text">Terms of service</h1>
        <p className="mt-6 leading-relaxed text-app-muted">
          This is a placeholder page for your demo deployment. Replace this content with your real terms,
          privacy policy links, and legal review before production use.
        </p>
      </div>
    </AppBackground>
  );
